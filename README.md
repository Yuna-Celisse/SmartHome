...
| 🎤 **语音开关灯** | 语音模块 (UART3) | 语音命令 0x0A/0x0B 手动控制灯光，覆盖自动模式 |
| 🎤 **语音调风扇** | 语音模块 (UART3) | 语音命令 0x01~0x05 手动控制风扇 5 档，覆盖自动模式 |
...
| 命令 | 字节 | 功能 |
|------|------|------|
| `FAN_OFF` | 0x01 | 风扇关闭（切换至 MANUAL 模式） |
| `FAN_L1` | 0x02 | 风扇 1 档 25%（切换至 MANUAL 模式） |
| `FAN_L2` | 0x03 | 风扇 2 档 50%（切换至 MANUAL 模式） |
| `FAN_L3` | 0x04 | 风扇 3 档 75%（切换至 MANUAL 模式） |
| `FAN_L4` | 0x05 | 风扇 4 档 100%（切换至 MANUAL 模式） |
| `LIGHT_OFF` | 0x0A | 手动关灯（切换至 MANUAL 模式） |
| `LIGHT_ON` | 0x0B | 手动开灯（切换至 MANUAL 模式） |
